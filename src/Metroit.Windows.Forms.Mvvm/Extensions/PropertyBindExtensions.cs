...
namespace Metroit.Windows.Forms.Mvvm.Extensions
{
    ...
    public static class PropertyBindExtensions
    {
            ...
            IFormatProvider formatInfo)
        {
            ...
            var control = targetControlInfo.Control as AutoCompleteBox;
            if (control == null)
            {
                throw new ArgumentException("The object resulting from a lambda expression is not a AutoCompleteBox object.");
            }
