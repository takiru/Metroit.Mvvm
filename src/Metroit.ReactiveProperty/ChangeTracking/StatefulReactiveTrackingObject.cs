...
namespace Metroit.ReactiveProperty.ChangeTracking
{
    ...
    public class StatefulReactiveTrackingObject<T1, T2> : ReactiveTrackingObject<T1, T2>, IStateObject where T1 : class where T2 : ReactivePropertyChangeTracker<T1>, new()
    {
