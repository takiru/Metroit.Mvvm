...
namespace Metroit.CommunityToolkit.Mvvm.ChangeTracking
{
    ...
    public class StatefulTrackingObservableRecipient<T1, T2> : TrackingObservableRecipient<T1, T2>, IStateObject where T1 : class where T2 : PropertyChangeTracker<T1>, new()
    {
