...
namespace Metroit.CommunityToolkit.Mvvm.ChangeTracking
{
    ...
    public class TrackingObservableValidator<T1, T2> : ObservableValidator, IPropertyChangeTrackerProvider<T1> where T1 : class where T2 : PropertyChangeTracker<T1>, new()
    {
