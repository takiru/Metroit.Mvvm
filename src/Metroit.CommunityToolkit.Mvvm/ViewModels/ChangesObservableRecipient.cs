...
namespace Metroit.CommunityToolkit.Mvvm.ViewModels
{
    ...
    /// </summary>
    public class ChangesObservableRecipient : ObservableRecipient
    {
        private PropertyChangeTracker<ChangesObservableRecipient> _propertyValueTracker = new PropertyChangeTracker<ChangesObservableRecipient>();
        ...
        /// 新しいインスタンスを生成します。
        /// </summary>
        public ChangesObservableRecipient()
        {
            ResetOriginalValues();
